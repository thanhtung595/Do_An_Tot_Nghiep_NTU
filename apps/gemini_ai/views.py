...
from .constants.gemini_ai_query_constants import SELECT_DOCTOR_ALL_VI
import json
import re
...
# Class xử lý chẩn đoán bệnh bằng AI
class DiagnoseAPIView(APIView):
    def post(self, request):
        ...
        try:
            ...
            # Trả về kết quả chẩn đoán và danh sách bác sĩ đề xuất
            return Response({
                "diagnosis": diagnosis,
